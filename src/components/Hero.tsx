...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container-professional relative z-10 max-w-7xl text-center">
        {/* Dramatic Serif Headline */}
        <h1 className="font-serif text-6xl md:text-8xl lg:text-9xl font-light text-white mb-8 leading-[0.95] tracking-tighter">
          Transform Your Business
        </h1>

        {/* Minimal Subheading */}
        <p className="text-sm md:text-base text-white/70 mb-16 leading-relaxed font-light max-w-xl mx-auto">
